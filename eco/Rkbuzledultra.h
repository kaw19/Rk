...
bool infravermelho(byte sensor) {     // retorna 'true' se estiver sobre superf. clara
//  int IVDir, IVEsq;
...
//  Serial.print("Dir.: "); Serial.println(IVDir); 
  return analogRead(sensor) < LIM_IV;  // valor alto (1020) sign. sup. escura, baixo (50) sign. sup. clara
}
