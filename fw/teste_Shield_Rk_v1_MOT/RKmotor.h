...
#define ENC_A         2               // pino da interrupção do Encoder 'A'
#define ENC_B         3               // pino da interrupção do Encoder 'B'
...
#define AJUSTE_MA     0.950
#define AJUSTE_MB     0.950
...
void mover(int dist, int vel) {
  ...
  int furos = FLOAT2INT(abs(dist)*2.666*20/20.9)-20; 
